...
<title> Sunrise Consultancy | Technofra</title>
<!-- Google tag (gtag.js) -->
...
<section class="pb-60">
    <div class="cover-image">
        <img src="assets\image\casestudy\sunriseconsultancy\1.webp" alt="Sunrise Consultancy case study">
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-10">
                <div class=" crm-title section-heading">
                    ...
                    <p> Sunrise Consultancy delivers skilled, reliable manpower with expert industry insight, ensuring consistent quality for businesses.
                    </p>

                </div>
            </div>
            <div class="col-lg-2">
                <a href="https://sunriseconsultancy.net/" target="blank" class="btn btn-outline-info mt-20">Explore More</a>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\sunriseconsultancy\2.webp" alt="Sunrise Consultancy case study" class="dp-r-10" data-aos="zoom-in-up">
            </div>
        </div>
    </div>
</section>
...
<section class="counter-with-video pb-60">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\sunriseconsultancy\3.webp" alt="Sunrise Consultancy case study" class="dp-r-10"
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 mb-20">
                <img src="assets\image\casestudy\sunriseconsultancy\4.webp" alt="Sunrise Consultancy case study" class="dp-r-10"
            ...
            <div class="col-lg-6 col-md-6">
                <div class=" section-heading" data-aos="zoom-in-left">
                  ...
                  Your Trusted Partner in Recruitment
                    ...
                    <div class="space16"></div>
                    <p>Sunrise Consultancy offers expert manpower solutions across industries, combining deep industry knowledge, quality focus, and client satisfaction to deliver skilled professionals at every organizational level.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="counter-with-video pb-60">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\sunriseconsultancy\5.webp" alt="Sunrise Consultancy case study" class="dp-r-10"
...
<section class="counter-with-video pb-60">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 col-md-6">
                <img src="assets\image\casestudy\sunriseconsultancy\6.webp" alt="Sunrise Consultancy case study"
    ...
    <div class="container">
        <div class="row" data-aos="zoom-out-up">
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\sunriseconsultancy\7.webp" alt="Sunrise Consultancy case study" class="dp-r-10 mb-4">
            </div>
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\sunriseconsultancy\8.webp" alt="Sunrise Consultancy case study" class="dp-r-10 mb-4">
            </div>
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\sunriseconsultancy\9.webp" alt="Sunrise Consultancy case study" class="dp-r-10 mb-4">
            </div>
