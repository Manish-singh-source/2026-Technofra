...
<title> VLegends | Technofra</title>
<!-- Google tag (gtag.js) -->
...
<section class="pb-60">
    <div class="cover-image">
        <img src="assets\image\casestudy\vlegends\banner.png" alt="V Legends case study">
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-10">
                <div class=" crm-title section-heading">
                    ...
                    <p> Welcome to Vlegends Gym & MMA – where fitness meets discipline, and legends are made.  
                    </p>

                </div>
            </div>
            <div class="col-lg-2">
                <a href="https://vlegends.in/" target="blank" class="btn btn-outline-info mt-20">Explore More</a>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\vlegends\about1.webp" alt="V Legends case study" class="dp-r-10" data-aos="zoom-in-up">
            </div>
        </div>
    </div>
</section>
...
<section class="counter-with-video pb-60">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\vlegends\responsive.webp" alt="V Legends case study" class="dp-r-10"
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 mb-20">
                <img src="assets\image\casestudy\vlegends\social-md.webp" alt="V Legends case study" class="dp-r-10"
            ...
            <div class="col-lg-6 col-md-6">
                <div class=" section-heading" data-aos="zoom-in-left">
                    ...
                    <div class="space16"></div>
                    <p>At Vlegends Gym & MMA, we follow a streamlined process to ensure that every member achieves their fitness goals efficiently.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- <section class="counter-with-video pb-60">
    <div class="container">
        ...
        <div class="row align-items-center dpreverse">
            ...
            <div class="col-lg-6 col-md-6 mb-20">
                <img src="assets/image/casestudy/sanjayagencies/sanjayagencies03.webp" alt="V Legends case study" class="dp-r-10"
...
<section class="counter-with-video pb-60">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12">
                <img src="assets\image\casestudy\vlegends\about.webp" alt="V Legends case study" class="dp-r-10"
...
<section class="counter-with-video pb-60">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 col-md-6">
                <img src="assets\image\casestudy\vlegends\technology.webp" alt="V Legends case study"
    ...
    <div class="container">
        <div class="row" data-aos="zoom-out-up">
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\vlegends\st1.webp" alt="V Legends case study" class="dp-r-10 mb-4">
            </div>
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\vlegends\st2.webp" alt="V Legends case study" class="dp-r-10 mb-4">
            </div>
            <div class="col-lg-4 col-md-4">
                <img src="assets\image\casestudy\vlegends\st3.webp" alt="V Legends case study" class="dp-r-10 mb-4">
            </div>
