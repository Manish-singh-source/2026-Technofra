...
<title>V P & SONS Case Study | Technofra</title>
<style>
.cover-image {
    display: flex;
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6">
                <div class="section-heading text-center" data-aos="zoom-out-right">
                    <h2>V.P. & SONS</h2>
                    <p>VPS has manoeuvred itself as an outstanding performer in the field of agriculture and
                        international trading. We pride ourselves on our knowledge of quality standards in the US,
                        Europe, the Middle East, Canada, and Asia.</p>
                    <a href="https://vpsons.com/" target="blank" class="btn btn-outline-info mt-20">Explore More</a>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        <h2>Contemporary Business Organization</h2>
                        <p>
                            While being a contemporary business organization, we continue to believe in traditional
                            values of trust, integrity, and quality.
                            With loyal and satisfied customers, the company stands strong on the foundation of its
                            success by consistently living up to its commitments and customers’ expectations while
                            providing a wide range of agri products.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        <h2> Product Space</h2>
                        <p>
                            Our dedicated team members are associated with us since the inception of our company. This
                            makes them a specialist in the domain of spices – Oil Seeds, Raisin and herbal products an
                            integral part of our success story.The company is expanding into new and innovative
                            prospects with a missionary zeal and a dynamic team.
                        </p>
                    </div>
                </div>
            </div>
