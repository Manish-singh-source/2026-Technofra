...
<title>Jagdamba Paper Corporation (JPC) Case Study | Technofra</title>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        <h2>Jagdamba Paper Corporation</h2>
                        <p>
                            Jagdamba Paper Corporation (JPC) is a well-known name in the paper industry. It is a leading
                            integrated paper trading house dealing in a wide range of products, including printing
                            paper, woodfree paper, newsprint paper, copier paper, packaging paper, and specialty paper.
                        </p>
                        <a href="https://jpcindia.in/" target="blank" class="btn btn-outline-info mt-20">Explore
                            More</a>
                    </div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        ...
                        <p>
                            Typography & Colours
                            We've incorporated two new typefaces, Bakbak One for primary use and Gotham for secondary
                            use, while maintaining the existing color scheme from the previous design.
                        </p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-10">
                <div class="text-center section-heading">
                    ...
                    <p>We paid special attention to the homepage to create a blend of moving elements, video
                        backgrounds, cinemagraphs, and beautiful lines.</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
