  ...
  -------------------------------------------------------------------------------------*/
    ...
    const reel = () => {
        if ($(".hero__reel-wrap").length) {
            ...
            growTL.to(reelWrap, { scale: 1, ease: "power2.out" }, 0);
            growTL.to(reel, { borderRadius: 12, ease: "power2.out" }, 0);
            ...
            ScrollTrigger.matchMedia({
                "(min-width: 768px)": function () {
                    ...
                    gsap.set(reelWrap, { width: SMALL_W, height: SMALL_H });
                ...
                "(max-width: 767px)": function () {
                    ...
                    gsap.set([reelWrap, reel], { clearProps: "all" });
                },
            });
