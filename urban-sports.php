...
<title>Urban Sports Case Study | Technofra</title>
<style>
.pt-60 {
    padding-top: 60px;
}
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        <h2>Urban sports</h2>
                        <p>
                            Urbansports makes turf booking fast and effortless. Discover venues, check availability,
                            choose convenient payment options, and confirm your booking—all within minutes.
                            <a href="https://urbansports.in/" target="blank" class="btn btn-outline-info mt-20">Explore
                                More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-5 mob-pt-20">
                <div class="feature-img-content">
                    <div class="section-heading" data-aos="fade-up">
                        <h2>Urban Sports</h2>
                        <p>
                            We're young, energetic, and focused—we bleed blue. We're dreamers. We dream big. We dream
                            sports. We're hard workers. We sweat and strive to realize what we've set our hearts on. And
                            we've come up with a spectacular game plan to provide youth with something they lack—the
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p>We've capitalised on our vision by kicking off Urban Sports - Our biggest playing field. We've
                        moved mountains to achieve our goal of creating an uprising of sorts in the two sports our
                        country breathes in day and night - Cricket and Football.</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6">
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    ...
                    <h2>Young, energetic and focused</h2>
                    <p>We've capitalised on our vision by kicking off Urban Sports - Our biggest playing field. We've
                        moved mountains to achieve our goal of creating an uprising of sorts in the two sports our
                        country breathes in day and night - Cricket and Football.</p>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8">
                ...
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    ...
                    <div class="space16"></div>
                    <p>In today’s digital world, your audience accesses your content from a variety of devices. Our
                        responsive design ensures your portfolio looks stunning and functions seamlessly on desktops,
                        tablets, and smartphones alike. Experience a user-friendly interface tailored to captivate and
                        engage visitors, no matter how they view it.</p>
