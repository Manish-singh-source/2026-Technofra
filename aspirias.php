...
<meta name="description"
    ...
    <title>Aspirias Teacher Training Centre Case Study | Technofra</title>
<style>
    .cover-image {
        display: flex;
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8 col-md-8">
                <div class="section-heading">
                    <h2>Aspirias Teacher Training Center</h2>
                    <div class="space16"></div>
                    <p>
                        We believe that education begins with the teacher. Founded with the vision of elevating teaching standards, we offer comprehensive training programs designed to enhance the skills, knowledge, and confidence of educators.</p>
                </div>
            </div>
            <div class="col-lg-2">
                <a href="https://aspirias.in/" target="_blank" class="btn btn-outline-info mt-20">Explore More</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 ">
                <div class="section-heading">
                    ...
                    <p>
                        Our design ensures a seamless and user-friendly experience on all devices, especially mobiles. With adaptive layouts and intuitive navigation, users can enjoy effortless accessibility and optimal readability anytime, anywhere.
                    </p>
                </div>
            </div>
        </div>
