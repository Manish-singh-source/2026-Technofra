...
<title>WordPress Development Services | Custom Websites & Solutions | Technofra</title>
<meta name="description"
    content="We offer expert WordPress development services, creating custom, scalable, and high-performance websites tailored to your business needs.">
...
.bg-gradient {
    ...
    background: linear-gradient(90deg, #709fb5, #1c759a) !important;
}
...
<div class="main-wrapper">
    <!--hero section start-->
    <section class="hero-section tabs pt-120 pb-100 bg-gradient bg-dark text-white"
        style="background: url('assets/img/hero-dot-bg.png')no-repeat bottom left">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-5 col-md-12">
                    <div class="section-heading" data-aos="fade-up">
                        ...
                        <h2>Benefits of WordPress Website Development</h2>
                        ...
                        <ul class="list-unstyled mt-5">
                            <li class="d-flex align-items-start mb-4">
                                ...
                                <div class="icon-content">
                                    <h3 class="h5">
                                        Multiple device accessibility:</h3>
                                    <p>WordPress is a powerful platform that simplifies creating responsive,
                                        mobile-optimized websites for all devices.
                                    </p>
                                </div>
                            </li>
                            <li class="d-flex align-items-start mb-4">
                                ...
                                <div class="icon-content">
                                    <h3 class="h5">SEO Friendly:</h3>
                                    <p>Building a website is easier with WordPress, thanks to built-in SEO tools that
                                        help optimize content for keywords and phrases.
                                    </p>
                                </div>
                            </li>
                            <li class="d-flex align-items-start mb-4">
                                ...
                                <div class="icon-content">
                                    <h3 class="h5">Low Investment:</h3>
                                    <p>WordPress offers a cost-effective solution for small businesses and helps large
                                        businesses save time for other priorities.
                                    </p>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="feature-img-wrap position-relative d-flex flex-column align-items-end">
                        <ul class="img-overlay-list list-unstyled position-absolute">
                            <li class="d-flex align-items-center bg-white rounded shadow-sm p-3" data-aos="fade-up"
                                ...
                                <h6 class="mb-0">Versatility And Scalability</h6>
                            </li>
                            <li class="d-flex align-items-center bg-white rounded shadow-sm p-3" data-aos="fade-up"
                                data-aos-delay="100">
                                <i class="fas fa-check bg-primary text-white rounded-circle"></i>
                                <h6 class="mb-0">Faster Deployment</h6>
                            </li>
                            <li class="d-flex align-items-center bg-white rounded shadow-sm p-3" data-aos="fade-up"
                                data-aos-delay="150">
                                <i class="fas fa-check bg-primary text-white rounded-circle"></i>
    ...
    <section class="faq-section bg-light-subtle  pt-60 pb-60">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading text-center" data-aos="fade-up">
                        ...
                        <p class="mt-3">Design and launch your website fast & no coding knowledge is required.</p>
                        <div class="row mt-5">
                            <!-- Tabs Section -->
                            <div class="col-lg-3">
                                <ul class="nav flex-column" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin active" id="tab1" data-bs-toggle="pill"
                                            data-bs-target="#image1" type="button" role="tab" aria-controls="image1"
                                            aria-selected="true">
                                            <i class="fas fa-paint-brush me-2"></i> <!-- Icon -->
                                            Live Visual Builder
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab2" data-bs-toggle="pill" data-bs-target="#image2"
                                            ...
                                            <i class="fas fa-columns me-2"></i> <!-- Icon -->
                                            Layout Builder
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab3" data-bs-toggle="pill" data-bs-target="#image3"
                                            ...
                                            <i class="fas fa-layer-group me-2"></i> <!-- Icon -->
                                            Header Builder
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab4" data-bs-toggle="pill" data-bs-target="#image4"
                                            ...
                                            <i class="fas fa-bars me-2"></i> <!-- Icon -->
                                            Mega Menu
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab5" data-bs-toggle="pill" data-bs-target="#image5"
                                            ...
                                            <i class="fas fa-border-top me-2"></i> <!-- Icon -->
                                            Footer Builder
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab6" data-bs-toggle="pill" data-bs-target="#image6"
                                            ...
                                            <i class="fas fa-file-alt me-2"></i> <!-- Icon -->
                                            Form Builder
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab7" data-bs-toggle="pill" data-bs-target="#image7"
                                            type="button" role="tab" aria-controls="image7" aria-selected="false">
                                            <i class="fas fa-window-restore me-2"></i> <!-- Icon -->
                                            Off Canvas
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab8" data-bs-toggle="pill" data-bs-target="#image8"
                                            type="button" role="tab" aria-controls="image8" aria-selected="false">
                                            <i class="fas fa-magic me-2"></i> <!-- Icon -->
                                            Setup Wizard
                                        </p>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <p class="nav-lin" id="tab9" data-bs-toggle="pill" data-bs-target="#image9"
                                            type="button" role="tab" aria-controls="image9" aria-selected="false">
                                            <i class="fas fa-tachometer-alt me-2"></i> <!-- Icon -->
                                            Performance Wizard
                                        </p>
                                    </li>
                                </ul>
    ...
    <section class="ptb-60" style="background-color: #f0ffff;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center mb-5">
                        <h2 class=" mb-4" style="color: #000;">Our Wordpress Design
    ...
    <div class="service10 case8 pt-60 pb-60 bg9">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class=" crm-title section-heading">
                        <!-- <span class="crm-subtitle ">API Integration <img src="assets/image/arrow-red.png" alt="arrow"></span> -->
                        <h2>
                            Why Choose WordPress
                        </h2>

                        <div class="space16"></div>
                        <p>As a market-leading custom WordPress development company, acquire a wide scope of
                            best-in-class and highly proficient web solution development capabilities created to match
                            the unique needs of your business while remaining attractive to the global consumer</p>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="arrows-button">
                        <button class="service10-next-arrow"><i class="fa-solid fa-arrow-left"></i></button>
                        <button class="service10-prev-arrow"><i class="fa-solid fa-arrow-right"></i></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="case8-box">
                                ...
                                <div class="hover-area">
                                    <div class="hover-heaer">
                                        ...
                                        <a href="project-details.html">Secure and Reliable</a>
                                    </div>
                                    <p>Regular updates and robust security features keep your WordPress site safe.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion faq-accordion my-5" id="accordionExample-2">
                                <div class="accordion-item border border-2 active">
                                    ...
                                    <div id="collapse-2-1" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            you to create and manage websites. It provides themes, plugins, and an
                                            intuitive dashboard to customize your site without coding knowledge.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border border-2">
                                    ...
                                    <div id="collapse-2-2" class="accordion-collapse collapse" aria-labelledby="faq-2-2"
                                        ...
                                        <div class="accordion-body">
                                            WordPress.com is a hosted platform where your website is managed for you,
                                            while WordPress.org is a self-hosted solution where you need to install and
                                            manage WordPress on your own hosting server.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border border-2">
                                    ...
                                    <div id="collapse-2-3" class="accordion-collapse collapse" aria-labelledby="faq-2-3"
                                        data-bs-parent="#accordionExample-2">
                                        <div class="accordion-body">
                                            You can install a theme by navigating to your WordPress dashboard >
                                            Appearance > Themes > Add New, then choose a free theme from the library or
                                            upload a premium theme in .zip format.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item border border-2">
                                    ...
                                    <div id="collapse-2-4" class="accordion-collapse collapse" aria-labelledby="faq-2-4"
                                        data-bs-parent="#accordionExample-2">
                                        <div class="accordion-body">
                                            Plugins are add-ons that enhance your WordPress site with additional
                                            features and functionalities. To install a plugin, go to Plugins > Add New
                                            in your dashboard, search for the plugin, or upload a .zip file of the
                                            plugin.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item border border-2">
                                    ...
                                    <div id="collapse-2-5" class="accordion-collapse collapse" aria-labelledby="faq-2-5"
                                        data-bs-parent="#accordionExample-2">
                                        <div class="accordion-body">
                                            You can secure your WordPress site by keeping WordPress, themes, and plugins
                                            updated, using strong passwords, installing a security plugin (like
                                            Wordfence or Sucuri), enabling SSL, and regularly backing up your website.
                                        </div>
                                    </div>
                                </div>
                            </div>
