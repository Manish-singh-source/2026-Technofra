...
<title>ISH International Case Study | Technofra</title>
<!-- Google tag (gtag.js) -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-8">
                    <div class="text-center section-heading">
                        ...
                        <p>Engaging and impactful social media videos designed to captivate audiences, enhance brand
                            visibility, and drive meaningful interactions across all platforms.</p>
                        <a href="https://www.ishinternational.in/" target="blank"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="section-heading" data-aos="fade-left">
                    <h2>
                        Manufacturers of All Types of Wet Wipes
                    </h2>
                    <div class="space16"></div>
                    <p>
                        A unit certified under the Drug and Cosmetics Act. Our primary focus is on
                        the surgical, pharmaceutical, hospital, retail, and home care sectors,
                        where we provide innovative solutions that enhance care and comfort for our consumers.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-10">
                <div class="text-center section-heading">
                    ...
                    <div class="space16"></div>
                    <p>Creating eye-catching and engaging ad campaigns tailored to capture attention and drive results
                        on platforms like Facebook, Instagram, LinkedIn, and more. Boost your brand’s visibility and
                        connect with your audience effectively.</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
