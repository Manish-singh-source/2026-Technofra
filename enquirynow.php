            ...
            <div class="col-lg-5">
                <div class="quote-side-card">
                    ...
                    <div class="quote-contact-stack">
                        ...
                        <div class="quote-contact-item">
                            <i class="fas fa-phone-alt" style="rotate: 90deg;"></i>
                            <div>
                                <h4>Call Us</h4>
                                <p>Sales: <a href="tel:+918080803374">+91 8080 80 3374</a> / <a
                                        href="tel:+918080803375">+91 8080 80 3375</a></p>
                                <p>Support: <a href="tel:+918080621003">+91 8080 62 1003</a> / <a
                                        href="tel:+918080721003">+91 8080 72 1003</a></p>
                            </div>
                        </div>
                        <div class="quote-contact-item">
                        ...
                        <div class="quote-contact-item">
                            ...
                            <div>
                                ...
                                <ul class="quote-social-list pt-2">
                                    <li><a href="https://www.facebook.com/Technofra/" aria-label="Facebook"><i
                                                class="fab fa-facebook-f ic"></i></a></li>
                                    <li><a href="https://www.instagram.com/technofra.company/" aria-label="Instagram"><i
                                                class="fab fa-instagram ic"></i></a></li>
                                    <li><a href="https://x.com/Technofra_" aria-label="X"><i
                                                class="fab fa-x-twitter ic"></i></a></li>
                                    <li><a href="https://hk.linkedin.com/company/technofra" aria-label="LinkedIn"><i
                                                class="fab fa-linkedin-in ic"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="send1.php" class="risk-contact-form" method="POST">
                        <div class="row">
                            <div class="col-md-6 quote-field">
                                <label for="quoteName">Full Name <span class="risk-highlight-color">*</span></label>
                                <input type="text" id="quoteName" name="name" placeholder="Enter your full name"
                                    autocomplete="name" required>
                            </div>

                            <div class="col-md-6 quote-field">
                                <label for="quoteEmail">Work Email <span class="risk-highlight-color">*</span></label>
                                <input type="email" id="quoteEmail" name="email" placeholder="Enter your email address"
                            ...
                            <div class="col-md-6 quote-field">
                                <label for="quoteContact">Phone Number <span
                                        class="risk-highlight-color">*</span></label>
                                <input type="tel" id="quoteContact" name="contact"
                                    placeholder="Enter your 10-digit mobile number" inputmode="numeric"
                                    pattern="[0-9]{10}" minlength="10" maxlength="10" autocomplete="tel" required>
                            </div>
