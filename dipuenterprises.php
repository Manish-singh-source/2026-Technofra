        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8">
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    <h2> Your One Stop Clothing Solution</h2>
                    <p>Our decades of garment manufacturing expertise have enabled us to develop efficient manufacturing methods that are geared towards optimizing production, reducing lead times, and maintaining high-quality standards. Thus, we are capable of fulfilling any requirement made by renowned brands today.</p>
                    <a href="https://dipuenterprises.com/" target="blank" class="btn btn-outline-info mt-20">Explore More</a>
                </div>
            </div>
        </div>
