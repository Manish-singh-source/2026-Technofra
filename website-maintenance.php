...
.bg-gradient {
    background: linear-gradient(90deg, #12253c, #10263e) !important;
}
</style>
            ...
            <div class="col-lg-5 col-md-10">
                <div>
                    ...
                    <p class="lead" data-aos="fade-up">
                        Website Maintenance Services – We take care of your website so you can focus on your business.

                        Website maintenance involves regularly checking your website for issues and errors, and keeping
                        it updated and relevant. This should be done consistently to ensure your website remains secure,
                        supports ongoing traffic growth, and improves your SEO and search rankings.
                    </p>
                </div>
            </div>
            <div class="col-lg-7">

                <div class="feature-img-wrap pt-120 pb-60 position-relative d-flex flex-column align-items-end">
                    <ul class="img-overlay-list list-unstyled position-absolute">
                        <li class="d-flex align-items-center bg-white rounded shadow-sm p-3 aos-init aos-animate"
                            data-aos="fade-up" data-aos-delay="50">
                            <i class="fas fa-check bg-primary text-white rounded-circle"></i>
                            <h6 class="mb-0">Website Updates</h6>
                        </li>
                        <li class="d-flex align-items-center bg-white rounded shadow-sm p-3 aos-init aos-animate"
            ...
            <div class="col-lg-4 col-md-6 p-0">
                <div class="single-service p-lg-5 p-4 dvs text-center mt-3 border-bottom border-end">
                    ...
                    <div class="service-info-wrap">
                        ...
                        <p>
                            Website is a growing platform. It’s updating daily. To keep website secure, error-free, we
                            need to update the database, themes, and Security regularly.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 p-0">
                <div class="single-service p-lg-5 p-4 dvs text-center mt-3 border-bottom border-end">
                    ...
                    <div class="feature-info-wrap">
                        ...
                        <p>
                            Website is a dynamic website building platform, it stores all the data including blog posts,
                            pages, comments, post and pages revisions, users, settings.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 p-0">
                <div class="single-service p-lg-5 p-4 dvs text-center mt-3 border-bottom">
                    ...
                    <div class="service-info-wrap">
                        ...
                        <p>
                            Website is an open-source platform maintained by a large community. Most of the plugins and
                            themes are created and maintained by the community.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="single-service p-lg-5 p-4 dvs text-center">
                    ...
                    <div class="feature-info-wrap">
                        ...
                        <p>
                            ...
                            Your website should have all the information up-to-date. The outdated business information
                            like address, phone numbers, email addresses.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="cyber-cta ptb-100">
    <div class="container">
...
<section class="process-section bg-light-subtle ptb-50">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="section-heading text-center" data-aos="fade-up">
                    <h2>Here is the list of the things we can help you with.</h2>
                    ...
                    <div class="row pt-60">
                            ...
                            <div class="footer-single-col">
                                <ul class="list-unstyled mb-0" style="text-align:justify;">
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Update content on pages, posts</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Boost page speed</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Secure your website</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Update plugins</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Install recommended plugins</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Configure a plugin</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Recover your hacked website</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Optimize images</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Offsite Backup of your Website</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Update WordPress version</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Update theme</span></li>
                                </ul>
                        ...
                        <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                            <div class="footer-single-col">
                                <ul class="list-unstyled mb-0" style="text-align:justify;">
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Fix issues after migration</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Fix issues after core updates</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Recommend plugin</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Install a caching plugin</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Create a child theme</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Install Commenting plugin</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Add / replace Logo</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                    ...
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Create social profiles</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                            <div class="footer-single-col">
                                <ul class="list-unstyled mb-0" style="text-align:justify;">
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Prevent Spams</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Issues with css and alignment</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Check Google indexing</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Change in header, footer and sidebar</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Configure premium theme as per demo</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Configure a plugin</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Spam comments clean </span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i> <span
                                            class="manishq">Check website speed and size</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Add, edit Woo-commerce products</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Scan your website</span></li>
                                    <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i><span
                                            class="manishq"> Link social profiles</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion faq-accordion " id="accordionExample-2">
                            <div class="accordion-item border border-2 active">
                                ...
                                <div id="collapse-2-1" class="accordion-collapse collapse " aria-labelledby="faq-2-1"
                                    ...
                                    <div class="accordion-body">
                                        Website maintenance involves regularly checking your website for issues,
                                        updating software, fixing bugs, optimizing performance, and ensuring it remains
                                        secure. It is crucial for keeping your website functional, improving user
                                        experience, and safeguarding against potential security threats. Regular
                                        maintenance also helps your site stay compatible with the latest browsers and
                                        devices, ensuring it meets modern standards.
                            ...
                            <div class="accordion-item border border-2">
                                <h5 class="accordion-header" id="faq-2-2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What tasks are included in your website maintenance services?
                                    </button>
                                </h5>
                                <div id="collapse-2-2" class="accordion-collapse collapse" aria-labelledby="faq-2-2"
                                    data-bs-parent="#accordionExample-2">
                                    <div class="accordion-body">
                                        Our website maintenance services include software updates, performance
                                        optimization, security checks, regular backups, bug fixes, content updates, and
                                        ensuring compatibility with new technologies. We also monitor your website for
                                        uptime and address any technical issues promptly to minimize disruptions.
                            ...
                            <div class="accordion-item border border-2">
                                ...
                                <div id="collapse-2-3" class="accordion-collapse collapse" aria-labelledby="faq-2-3"
                                    data-bs-parent="#accordionExample-2">
                                    <div class="accordion-body">
                                        The frequency of maintenance depends on your website’s size, complexity, and
                                        purpose. For most websites, we recommend monthly maintenance, which includes
                                        updates, backups, and performance checks. However, high-traffic or e-commerce
                                        sites may require weekly or even daily attention to ensure smooth operation and
                                        data security.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border border-2">
                                ...
                                <div id="collapse-2-4" class="accordion-collapse collapse" aria-labelledby="faq-2-4"
                                    data-bs-parent="#accordionExample-2">
                                    <div class="accordion-body">
                                        Skipping regular maintenance can lead to a host of issues, including slower
                                        website performance, increased vulnerability to security breaches, and potential
                                        loss of data due to outdated backups. Over time, your website may become
                                        incompatible with newer devices or browsers, leading to a poor user experience
                            ...
                            <div class="accordion-item border border-2">
                                <h5 class="accordion-header" id="faq-2-5">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Can I customize a maintenance plan for my specific needs?
                                    </button>
                                </h5>
                                <div id="collapse-2-5" class="accordion-collapse collapse" aria-labelledby="faq-2-5"
                                    data-bs-parent="#accordionExample-2">
                                    <div class="accordion-body">
                                        Yes, we offer flexible maintenance plans tailored to your website’s specific
                                        needs and budget. Whether you require occasional updates, regular monitoring, or
                                        comprehensive support, we’ll design a package that aligns with your business
                                        goals. Our team ensures your website remains secure, functional, and up-to-date,
