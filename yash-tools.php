...
<meta name="description"
    ...
    <title>Yash Tools Case Study | Technofra</title>
<style>
    .cover-image {
        display: flex;
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8 col-md-8">
                <div class="section-heading">
                    ...
                    <p>
                    YASH TOOLS ( I ) PVT. LTD. was founded on the principle of working together with our customers to fully understand your individual applications and needs and making every effort to provide you with the best possible solutions.</p>
                </div>
            </div>
            <div class="col-lg-2">
                <a href="https://yashtools.in/" target="_blank" class="btn btn-outline-info mt-20">Explore More</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 ">
                <div class="section-heading">
                    ...
                    <div class="space16"></div>
                    <p>Build a strong digital presence with strategic social media branding. Engage your audience, boost visibility, and create lasting impressions with compelling content, consistent aesthetics, and powerful storytelling that connects with your audience across all platforms.</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
